...
The Forge repository's root workflows validate this project on pull requests
and pushes to `main`. Generated nested workflows were removed because GitHub
does not discover workflows below the repository root. The root automation
separates static quality, coverage-enforced
